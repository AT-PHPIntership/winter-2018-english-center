        <!-- favicon
		============================================ -->		
        <link rel="shortcut icon" type="image/x-icon" href="front_end/img/favicon.ico">
        ...
        <!-- Nivo slider CSS
		============================================ -->
		<link rel="stylesheet" href="front_end/lib/nivo-slider/css/nivo-slider.css" type="text/css" />
		<link rel="stylesheet" href="front_end/lib/nivo-slider/css/preview.css" type="text/css" media="screen" />
        
		<!-- Metarial Iconic Font CSS
		============================================ -->
        <link rel="stylesheet" href="front_end/css/material-design-iconic-font.css">
        <link rel="stylesheet" href="front_end/css/material-design-iconic-font.min.css">
