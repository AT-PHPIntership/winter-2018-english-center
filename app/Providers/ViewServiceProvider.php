...
class ViewServiceProvider extends ServiceProvider
{
    ...
    {
        view()->composer(['backend.courses.create','backend.courses.edit', 'frontend.layouts.partials.header', 'frontend.pages.course'], 'App\Http\ViewComposers\CourseComposer');
